...
#
# Linux 5.4 qGKI (Qualcomm GKI 1.0) arm64 kernel build script.
# Toolchain: Snapdragon LLVM 10.0.9 + ARM GNU 14.2 (this era still needs a real GCC
# cross compiler). Identical recipe to build_5.4.sh -- qGKI trees are Linux 5.4.
#
# Put this in your kernel root, edit the settings below, then run:
#   chmod +x build_qGKI.sh && ./build_qGKI.sh
