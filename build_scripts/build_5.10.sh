...
#
# Linux 5.10 arm64 kernel build script.
# Toolchain: clang-r416183b (LLVM only -- no GCC cross compiler needed)
#
# Put this in your kernel root, edit the settings below, then run:
#   chmod +x build_5.10.sh && ./build_5.10.sh
...
CLANG="${HOME}/toolchains/clang-r416183b"
...
fetch "${CLANG}" "https://github.com/ravindu644/Android-Kernel-Tutorials/releases/download/toolchains/clang-r416183b.tar.gz"

# This clang wants libtinfo.so.5; no current distro ships it. If the compat
