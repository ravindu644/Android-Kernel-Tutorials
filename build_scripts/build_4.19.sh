...
if [ ! -d "${HOME}/toolchains/aarch64-linux-android-4.9" ]; then
    echo -e "\n[INFO] Cloning aarch64-linux-android-4.9 toolchain...\n"
    mkdir -p "${HOME}/toolchains/aarch64-linux-android-4.9" && cd "${HOME}/toolchains/aarch64-linux-android-4.9"
    ...
    tar -xf aarch64-linux-android-4.9.tar.gz && rm aarch64-linux-android-4.9.tar.gz
    cd "${RDIR}"
fi
...
export BUILD_CROSS_COMPILE="${HOME}/toolchains/aarch64-linux-android-4.9/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-"
