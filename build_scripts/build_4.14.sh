...
#
# Linux 4.14 arm64 kernel build script.
# Toolchain: clang-r383902b + ARM GNU 14.2 (this era still needs a real GCC cross compiler)
#
# Put this in your kernel root, edit the settings below, then run:
#   chmod +x build_4.14.sh && ./build_4.14.sh
...
BUILD_OPTIONS=(
    ...
    HOSTLDLIBS=-lyaml            # some trees build dtc with yaml support
)
